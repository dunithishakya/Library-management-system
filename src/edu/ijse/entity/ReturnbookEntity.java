...
public class ReturnbookEntity {
    ...
    public ReturnbookEntity(String bid, String mid, String rdate, String idate, String Fines) {
        this.bid = bid;
        this.mid = mid;
        this.rdate = rdate;
         this.idate = idate;
    ...
    public String toString() {
        return "ReturnbookEntity{" + "bid=" + bid + ", mid=" + mid + ", rdate=" + rdate + ", idate=" + idate + ", Fines=" + Fines + '}';
    }
